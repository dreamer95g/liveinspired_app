...
export const NoteCard = ({ history, note }) => {
  useEffect(() => {}, []);
  return (
    <div className="animate__animated animate__fadeIn inline-block mx-4 border-2 border-gray-50 max-w-sm p-6 m-auto my-5 bg-white rounded-2xl shadow-2xl dark:bg-gray-800">
      <p
